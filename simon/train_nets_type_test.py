...
bs = 5000;  # batch size
wdir = './type_test_freshly_trained_nets/'
...
def train_simon_distinguisher(num_epochs, num_rounds=7, depth=1,Diff=(0x200,0x880,0x0,0x40),BS=5000):  
    ...
    X, Y = sp.make_train_data_PDID_IDFT_3(10**7,num_rounds,diff = Diff); 
    sum = 0;
    for i in range(10**7):
       sum+=Y[i]
    print(sum)
    X_eval, Y_eval = sp.make_train_data_PDID_IDFT_3(10**6, num_rounds,diff = Diff);  
    ...
    X_test, Y_test = sp.make_train_data_PDID_IDFT_3(10**6, num_rounds, Diff);  
