...
bs = 5000;  # batch size
wdir = './type_idds_freshly_trained_nets/'
...
def train_simon_distinguisher(num_epochs, num_rounds=7, depth=1,Diff=(0x200,0x880),BS=5000):  
    ...
    print("choose chafen is: (0x%x, 0x%x) and round is: %d and epoch is:%d  and BS is:%d and data_type is:%d"%(Diff[0],Diff[1], num_rounds, num_epochs,BS,2));  
